...
export const GRATEFUL_DEAD_CONFIG: BandConfig = {
  ...
  eraPresets: {
    primal: {
      preferredModes: ["liquid_light", "oil_projector", "vintage_film", "feedback_recursion", "plasma_field", "stained_glass", "aurora_curtains", "smoke_rings"],
      excludedModes: ["concert_lighting", "crystal_cavern", "electric_arc", "digital_rain", "neural_web"],
    ...
    classic: {
      preferredModes: ["liquid_light", "tie_dye", "aurora", "oil_projector", "fractal_flames", "feedback_recursion", "plasma_field", "voronoi_flow", "stained_glass", "smoke_rings", "aurora_curtains", "lava_flow"],
    ...
    hiatus: {
      preferredModes: ["concert_lighting", "cosmic_voyage", "deep_ocean", "diffraction_rings", "morphogenesis", "voronoi_flow", "digital_rain", "neural_web"],
    ...
    touch_of_grey: {
      preferredModes: ["concert_lighting", "inferno", "tie_dye", "fractal_flames", "electric_arc", "plasma_field", "neural_web", "lava_flow", "digital_rain"],
      excludedModes: ["oil_projector"],
      excludedOverlays: [],
      grainIntensity: 0.6,
      colorTempShift: 0,
