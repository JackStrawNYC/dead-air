 ...
 *
 * Computes how much to suppress overlays and art when lyric triggers
 * are active, so they don't compete for visual attention.
 */
...
/**
 * Compute overlay suppression factor when lyric triggers are active.
